...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0"
    ...
    <xsl:template match="map/string[@key = 'pub_type_desc']" xpath-default-namespace="http://www.w3.org/2005/xpath-functions">
        ...
        <relatedItem>   
            <xsl:choose>
                <xsl:when test="matches(text(), ('Scientific Journal (JRNL)','Miscellaneous Publication')"
...
<!--                <xsl:when test="(document('commons/USFS_Research.xml')//(usfs:research/usfs:treeSeries/usfs:seriesPub/usfs:treePub) = ('Miscellaneous Publication' or 'Scientific Journal &lpar;JRNL&rpar;')) ">-->
    ...
    <xsl:template match="map/string[@key = 'pub_publication']" xpath-default-namespace="http://www.w3.org/2005/xpath-functions">
       <xsl:param name="pub_series" as="xs:string"/>
        ...
        <xsl:value-of select="$nodes//usfs:"
...
-->
    ...
    <xd:doc scope="component">
        <xd:desc>
            ...
            <xd:p><xd:b>filename_ext</xd:b>filename from source metadata (e.g., filename.xml, filename.json or filename.zip)</xd:p>
            ...
            <xd:p><xd:b>filePath</xd:b>included for quick access</xd:p>
        </xd:desc>
    </xd:doc>
