...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.loc.gov/mods/v3"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            ...
            <xd:p>Splits a modsCollection file into individual MODS files; also runs
                fix_characters.xsl</xd:p>
            <xd:p>Assigns a priority of "5" to the root template so as to avoid an ambiguous match
                warning</xd:p>
        </xd:desc>
    </xd:doc>
    ...
    <xsl:template match="/" priority="5">
        <xsl:for-each select="modsCollection/mods">
            <xsl:result-document method="xml" encoding="UTF-8" indent="yes"
                href="{*:extension/*:workingDirectory}N-{replace(*:extension/*:originalFile, '(.*/)(.*)(\.xml)', '$2')}_{position()}.xml">
                <mods version="3.7">
