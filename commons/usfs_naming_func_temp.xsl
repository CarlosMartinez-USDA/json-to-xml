...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:usfs="usfs_treesearch.xsd"
    ...
    <xsl:function name="usfs:unitNumberToName" as="xs:string?" xmlns:usfs="http://usfs_treesearch">
        ...
        <xsl:value-of select="$tree_nodes/usfs:treesearch/usfs:researchStations/usfs:station/usfs:researchUnits/usfs:unit[usfs:unitNumber=$unitNumber]/usfs:unitName"/> 
        </xsl:if>
    </xsl:function>
    ...
    <xsl:function name="usfs:unitNumberToAddress" as="xs:string?" xmlns:usfs="http://usfs_treesearch">
        <xsl:param name="unitNumber"/>    
        <xsl:if test="$unitNumber != ''">
        <xsl:value-of select="$tree_nodes/usfs:treesearch/usfs:researchStations/usfs:station/usfs:researchUnits/usfs:unit[usfs:unitNumber=$unitNumber]/usfs:unitAddress"/> 
        </xsl:if>
    </xsl:function>
