...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0"
    ...
    <xsl:template match="map" xpath-default-namespace="http://www.w3.org/2005/xpath-functions">
        ...
        <xsl:apply-templates select="./array[@key = 'primary_station']"/>
    ...
    <xsl:template
        match="map/array[@key = 'pub_authors'] | map/array[@key = 'primary_station']" xpath-default-namespace="http://www.w3.org/2005/xpath-functions">
        <xsl:choose>
    ...
    <!-- Get author's ORCID -->
     ...
     <xsl:template name="acronym" xpath-default-namespace="http://www.w3.org/2005/xpath-functions">
        <xsl:for-each select="array[@key='pub_data_type']">
    ...
    <xsl:template match="map/string[@key = 'primary_station']">
        <xsl:for-each select="map/string[@key=
        <name type="corporate">
